...
function DisplayProducts({ products, setProducts, addProduct, setSelectedProductId }) {
    ...
    const fetchProducts = useCallback(async (page = 1) => {
        ...
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:4000/api/getAllProducts?page=${page}&limit=10`, config);
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await axios.delete(`http://127.0.0.1:4000/api/deleteProduct/${id}`, config);
    ...
    const handleAddToBasket = async (productId) => {
        try {
            ...
            const response = await axios.post('http://127.0.0.1:4000/api/AddtoCart', {
                produitId: productId,
                quantite: 1,
            }, config);
    ...
    return (
        <div className=" productsShow m-0 p-0">
            ...
            <div className="productsList"> {loading ? (
                <p>Loading...</p>
            ) : role !== 'client' ? (
